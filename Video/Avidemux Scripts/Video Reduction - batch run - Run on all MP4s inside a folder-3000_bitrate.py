...
def convert(filein):
    ...
    adm.videoCodec("x264", "useAdvancedConfiguration=True", "general.params=2PASSBITRATE=3000", "general.threads=0", "general.preset=ultrafast", "general.tuning=none", "general.profile=baseline", "general.fast_decode=False", "general.zero_latency=False"
